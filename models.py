...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NEO {self.fullname} has a diameter of {self.diameter:.3f} km and {is_hazardous} potentially hazardous."
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        return f"On {time_str}, {full_name} approaches Earth at a distance of {self.distance:.2f} au and a velocity of {self.velocity:.2f} km/s."
